    ...
    <div className={darkMode ? "dark-mode" : "light-mode"}>
      <div className="super">
        <div className="pricing-container">
          <h1>Pricing</h1>
          <p>
            Experience seamless streaming, interactive chat, and community
            features designed for all your entertainment needs.
          </p>
          <div className="plans">
            <div className="plan">
              <h2>Free</h2>
              ...
              <p className="description">
                Perfect for casual users who want to explore our streaming
            ...
            <div className="plan">
              ...
              <p className="description">
                Ideal for regular users who want enhanced streaming quality and
                chat functionality.
              </p>
              <ul>
